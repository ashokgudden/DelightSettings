...
package com.delight.settings.preferences;
...
import com.delight.settings.preferences.ShortcutPickHelper;
import com.delight.settings.preferences.ActionPreference;
import com.delight.settings.preferences.CustomActionListAdapter;
...
public class ActionFragment extends SettingsPreferenceFragment implements
    ...
    public int getDialogMetricsCategory(int dialogId) {
        switch (dialogId) {
            case DIALOG_CATEGORY:
            case DIALOG_CUSTOM_ACTIONS:
                return MetricsEvent.delight_SETTINGS;
            default:
                return 0;
        }
    }
